...
class Timer extends React.Component {
    ...
    startTimer = (id) => {
        ...
        if (timerData && timerData.startDate && timerData.pauseDate && !timerData.timerId ||
    ...
    render() {
        ...
        return (
            <span className="description">
                  <button id={id} className="icon icon-play" onClick={(event) => this.startTimer(event.currentTarget.id)}></button>
                  <button id={id} className="icon icon-pause" onClick={(event) => this.pauseTimer(event.currentTarget.id)}></button>
                  {preparedTime}
            </span>
        );
    }
